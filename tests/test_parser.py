...
class TestInvalidHTMLFiles(unittest.TestCase):
    def test_empty_file(self):
        root = course_parser.parse_html('tests/HTML/empty.html')
        self.assertEqual(root.__str__(), '<root />')

    def test_empty_course_table(self):
        root = course_parser.parse_html('tests/HTML/empty_table.html')
    ...
    def test_invalid_entries(self):
        with self.assertRaises(Exception):
            root = course_parser.parse_html('tests/HTML/invalid_entries.html')
